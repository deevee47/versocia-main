...
const Contact = () => {
  ...
  return showContact ? (
    <section id='contact' className='footer h-screen w-full flex flex-col pt-2 sticky -z-10 bottom-0'>
      <span className="sm:px-20" ><Heading
        label={
      ...
      <div className='sm:px-20 pb-24 py-16 w-full justify-evenly flex flex-row'>
