      ...
      <div className="pt-16 sm:w-[60%] w-[80%] mx-auto flex justify-center flex-col items-center text-left">
        <FadeInUp>
          <div className="pb-16">
            ...
            <span className="font-bold">
              lifetime FREE premium ad copy insights and strategies valued at
              $350/month.{" "}
            </span>
          </div>
        </FadeInUp>
        ...
        <div>
          <FadeInUp>
            <span className="font-bold">
              We're not just about talk; we&apos;re ready to back it up.{" "}
            </span>
            That's why we offer a <span className="font-bold">30-day</span> free
            trial. If your customer inquiries aren't trending upwards after 30
